...
$h2_microblog_service = 'This micro-blogging service will give you:';
$h3_no_spy = '1. Full freedom of speech<br> 2. No spying<br> 3. No action logging';
$p_text_1 = 'Twister is fundamentally different from Twitter, it is impossible in Twister to block anyone or to remove messages or to deny access to information from a particular country. It is based on P2P architecture and combines the best of Bitcoin and Bittorrent';        
$btn_another_dif = 'What are other differences?';
$active_develop = 'Attention! Twister is still in active development, some functions may not work, keep this in mind!';
...
$personal_messages = 'Direct Messages';
$mentions = 'Mentions @';
$menu = 'Menu';
